...
export default function LandingPage() {
  return (
    <main className="min-h-screen bg-brand-cream text-brand-ink dark:bg-[#1F1A17] dark:text-[#F7EEE8]">
      <div className="mx-auto flex min-h-screen w-full max-w-[720px] flex-col px-6 py-8">
        ...
        <div className="flex flex-1 flex-col items-center justify-center">
          ...
          <div className="mt-8 text-center">
            <p className="mb-4 text-sm tracking-[0.2em] text-brand-softInk dark:text-[#CBBDB2]">
